...
| G8.2 | **FP16-accumulate + FP32 carry** (run the tensor core at 330 TF, rebuild precision outside it) | CLOSED | Accuracy IS reachable at the official K=128 with the finest carry (5 of 12 rows under the 0.00180 ship ceiling, job 235) -- the step-41 closure at K=512 was misleading here. But the tier is worth ~0% at these shapes: they achieve 0.6-27% of even the 165.2 TF lower tier, and accF32 vs accF16 differ by ~1% (job 236) where step 37 measured x1.43-1.53 at K=512/N=1536. Not accumulate-bound, so CUTLASS cannot help either -- it fixes efficiency, not arithmetic intensity. |
