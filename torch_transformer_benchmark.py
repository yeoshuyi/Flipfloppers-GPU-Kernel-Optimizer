#!/usr/bin/env python3
# GENERATED by tools/sync_entrypoint.py from benchmark.py + ~/torch_transformer_benchmark.py
# DO NOT EDIT. Edit benchmark.py and re-run tools/sync_entrypoint.py.
# The harness half is the judges' canonical script verbatim (guarded by tools/verify_baseline.py).
