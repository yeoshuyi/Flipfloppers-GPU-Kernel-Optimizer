...
# (and its module-level helpers) implemented in place of the stub. The scoring
# half - BaselineTransformer, compare_outputs, run_accuracy_tests, benchmark_models,
# parse_args, main - is byte-for-byte the reference harness; tools/verify_baseline.py
...
#
# Auto-generated from benchmark.py by tools/sync_entrypoint.py - edit benchmark.py,
